...
namespace osu.Game.Screens.Evast.Pixels.LifeGame
{
    public class LifeGamePlayfield : PixelField
    {
        ...
        private int countNearbyCells(int x, int y)
        {
            ...
            if (previousIterationMap[checkableX, checkableY])
                amount++;

            ////

            if (previousIterationMap[x, checkableY])
                amount++;
            ...
            if (previousIterationMap[checkableX, y])
                amount++;
